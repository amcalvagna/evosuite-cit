...
import org.evosuite.coverage.cit.CitCoverageGoal;
...
public class ExecutionResult implements Cloneable {
	...
	private Map<Integer, Set<CitCoverageGoal>> citGoals = new LinkedHashMap<>();
	...
	public ExecutionResult clone() {
		...
		copy.citGoals = new LinkedHashMap<>(citGoals);
	...
	public void setCitGoals(Map<Integer, Set<CitCoverageGoal>> coveredGoals) {
		citGoals.putAll(coveredGoals);
	...
	public Map<Integer, Set<CitCoverageGoal>> getCitGoals() {
        return citGoals;
	}
}
