...
import org.evosuite.coverage.cit.CitCoverageSuiteFitness;
...
public class SearchStatistics implements Listener<ClientStateInformation>{
	...
	private SearchStatistics() { 
		...
		sequenceOutputVariableFactories.put(RuntimeVariable.CitFitnessTimeline.name(), new CitFitnessSequenceOutputVariableFactory());
        sequenceOutputVariableFactories.put(RuntimeVariable.CitCoverageTimeline.name(), new CitCoverageSequenceOutputVariableFactory());
...
//            v.setValue((Integer)variable.getValue());
	...
	private static class CitFitnessSequenceOutputVariableFactory extends SequenceOutputVariableFactory<Double> {

        public CitFitnessSequenceOutputVariableFactory() {
            super(RuntimeVariable.CitFitnessTimeline);
        }

        @Override
        public Double getValue(TestSuiteChromosome individual) {
            return individual.getFitnessInstanceOf(CitCoverageSuiteFitness.class);
        }
    }
	private static class CitCoverageSequenceOutputVariableFactory extends SequenceOutputVariableFactory<Double> {

        public CitCoverageSequenceOutputVariableFactory() {
            super(RuntimeVariable.CitCoverageTimeline);
        }

        @Override
        public Double getValue(TestSuiteChromosome individual) {
            return individual.getCoverageInstanceOf(CitCoverageSuiteFitness.class);
        }
    }
